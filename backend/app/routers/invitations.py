...
def _out(inv: Invitation, *, raw_token: str | None = None) -> InvitationOut:
...
def create_invitation(company_id: uuid.UUID, req: CreateInvitationRequest,
    ...
    except Exception:  # noqa: BLE001 — best-effort notify; invitation still succeeds
    ...
    security_logger.info("invitation created", extra={
        ...
        "company_id": str(company_id), "role": req.role.value,
    })
    return _out(inv, raw_token=raw_token)
