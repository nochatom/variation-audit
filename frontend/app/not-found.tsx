  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-ip-bg px-4 font-ip text-ip-ink">
      <div className="w-full max-w-sm text-center">
        <div className="mx-auto mb-5 grid h-10 w-10 place-items-center rounded-md bg-ip-navy text-base font-bold text-white">V</div>
        ...
        <div className="mt-6 flex justify-center gap-2">
          <Link href="/dashboard" className="btn-navy">Go to Dashboard</Link>
          <Link href="/landing" className="btn-ghost">Back to site</Link>
        </div>
      </div>
    </main>
  );
